...
_.reduce = function(array, func, seed) {
    ...
    //if it does, loop through array and call func on each element
    //reassign seed to be value of that functio call
    if (seed !== undefined) {
        for (var i = 0; i < array.length; i++) {
            seed = func(seed, array[i], i);
        } return seed;
    } else {
        //if no seed given, first value of array is seed 
        seed = array[0];
        //call func on each value in array, starting at array[1] 
